...
public class EntityDeposit {
    ...
    public EntityDeposit(int deposit_id, String title, double amount, int currency_id, int interest_percentage, String description, int user_id, Date create_date, Date deadline, double status) {
